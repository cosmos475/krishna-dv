...
<style>
    ...
    * {{ margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }}
    ...
    .bottomSheet {{ position: fixed; left: 0; right: 0; bottom: -100%; background: var(--surface); border-radius: 20px 20px 0 0; padding: 20px; z-index: 101; transition: bottom 0.3s ease; max-width: 720px; margin: 0 auto; }}
...
<div class="topbar">
    ...
    {branding_html}
    <div class="iconRow"><div class="iconBtn" id="themeToggleBtn"><i class="fas fa-palette"></i></div></div>
</div>
<div class="container">
...
document.getElementById('themeToggleBtn').addEventListener('click', openThemeSheet);
applyPageTheme('dark');
